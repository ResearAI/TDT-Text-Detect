...
float16_models = ['gpt-j-6B', '/home/wyx/model/falcon-7b', '/home/wyx/model/falcon-7b-instruct']
...
def load_model(model_name, device, cache_dir):
    ...
    model = AutoModelForCausalLM.from_pretrained( model_fullname, trust_remote_code=True, **model_kwargs)
